...
<html>
<head>
    <title>诚薪贷_正规个人贷款_网络信贷平台-顶玺金融官网</title>
	<meta name="keywords" content="诚薪贷" />
	<meta name="description" content="顶玺金融诚薪贷适用于具有稳定、持续工资收入的企事业员工，有信用认证标、机构担保标。如果你想办理顶玺金融诚薪贷或者想办理正规个人贷款，详情请登陆www.dxjr.com。">
...
if(''!='${msg}'){
	layer.alert('${msg}');
	if(''!='${scrollToHeight}'){window.scrollTo(0,'1000');}
}
</script>
</body>
</html>